...
export function Verdict() {
  ...
  return (
    <div className="final-report" style={{ height: '100%', overflowY: 'auto', padding: '2rem' }}>
      ...
      <div className="big-joke" style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '20px', marginBottom: '1rem' }}>
          <img src="/chakka.png" alt="Chakka" style={{ width: '80px', height: 'auto', filter: 'drop-shadow(2px 6px 8px rgba(0,0,0,0.3))' }} />
          <span style={{ fontSize: '2rem', fontFamily: 'Georgia, serif', color: '#8d2e21' }}>💥</span>
          <img src="/rabbit.png" alt="Rabbit" style={{ width: '130px', height: 'auto', transform: 'scaleX(-1)', filter: 'drop-shadow(2px 6px 8px rgba(0,0,0,0.3))' }} />
        </div>
        <h1 style={{ fontSize: '2.5rem', margin: '0.5rem 0' }}>ചക്ക വീണു.</h1>
        <span style={{ fontSize: '1.4rem', display: 'block', marginBottom: '1rem', color: '#5a3d2b' }}>മുയൽ അവിടെ ഉണ്ടായിരുന്നു.</span>
        <strong style={{ fontSize: '2.2rem', color: '#c62828' }}>{physics.humanInterferenceProbability > 50 ? 'കൊലപാതകം! (FOUL PLAY)' : 'ഒരു യാദൃശ്ചികത? (PURE ACCIDENT)'}</strong>
      </div>
